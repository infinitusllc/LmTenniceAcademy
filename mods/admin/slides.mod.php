    ...
    <div>
        ...
        <?php if (isset($_GET["message"])) {
            ...
            switch ($message) {
                ...
                case "success": //unknown error
                    ?>  <p style="margin: auto; text-align: center; color:red"> სლაიდი წარმატებით დამატებულია </p>  <?php
                    break;
            }
        }
        ...
        <form id="slide-form" action="includes/add_slide.inc.php" method="post" accept-charset="UTF-8" enctype="multipart/form-data">
            ...
            foreach ($languages as $language) {
                ...
                <? } else {
                    $s = null; ?>
                    <input type="hidden" value="false" name="is_change">
                <?php } ?>
            ...
            <form name="line_<?php echo $i; ?>">
                ...
                <p style="text-align: center; width: auto; overflow: hidden; margin: auto">
                    <?php
                        ...
                        if (isset($slide['image_url']) && strlen($slide['image_url']) > 0) { ?>
                    ...
                    <a href="admin.php?tab=slides&keyword=<?php echo $slide['keyword']; ?>"> შეცვლა </a>
                </p>
            </form>
            <?php $i++; } ?>
    </div>
